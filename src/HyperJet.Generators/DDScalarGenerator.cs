...
{variablesFactory}
        ...
        {{
            if (TryConvertFromCheckedHelper<T, TOther>(value, out T doubleVal))
            {{
                result = new DDScalar{n}<T>(doubleVal);
                return true;
            }}
            result = default;
            return false;
        ...
        {{
            if (TryConvertFromSaturatingHelper<T, TOther>(value, out T doubleVal))
            {{
                result = new DDScalar{n}<T>(doubleVal);
                return true;
            }}
        ...
        {{
            if (TryConvertFromTruncatingHelper<T, TOther>(value, out T doubleVal))
            {{
                result = new DDScalar{n}<T>(doubleVal);
                return true;
            }}
